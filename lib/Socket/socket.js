...
const sendNode = (frame) => {
    ...
    try {
        ...
        if (isNewsletter) {
            ...
            console.log('\n==============================');
            console.log('🚨 NEWSLETTER SEND DETECTED');
            console.log('==============================');
            ...
            // 🧭 FILE ORIGIN (yang manggil sendNode)
            ...
            // 🧪 DETEKSI LUAR BAILEYS
            const isExternal = stackLines.some(l =>
                l.includes('node_modules') &&
                !l.includes('baileys')
            );

            if (isExternal) {
                console.log('\n⚠️ SOURCE: OUTSIDE BAILEYS');
            } else {
                console.log('\nℹ️ SOURCE: INSIDE BAILEYS');
            }
        ...
        console.log('SEND NODE DEBUG ERROR:', e);
    }
